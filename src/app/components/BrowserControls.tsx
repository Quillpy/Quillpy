        ...
        <div className="flex gap-1 ml-2">
          ...
          <button
            ...
            style={{ 
              ...
              color: canGoForward ? '#6f9f84' : '#3a4d42',
          ...
          {NAV_ICONS.map((link) => (
            <button
              ...
              style={{ 
                ...
                color: activeTab === link.path ? '#7fbf9a' : '#a6b8ad',
                border: '1px solid #1b2a24'
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.backgroundColor = '#1b2a24';
              ...
              onMouseLeave={(e) => {
                ...
                e.currentTarget.style.borderColor = '#1b2a24';
                e.currentTarget.style.color = activeTab === link.path ? '#7fbf9a' : '#a6b8ad';
              }}
              title={link.name}
            >
