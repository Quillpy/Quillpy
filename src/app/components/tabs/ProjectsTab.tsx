...
const projects: Project[] = [
  ...
  {
    title: 'Dotfiles',
    description: 'Personal KDE, and environment configuration files for Linux workflow.',
  ...
  {
    title: 'Maggie-Man',
    description: 'Discord bot that follows one Lichess broadcast per server and send updates',
