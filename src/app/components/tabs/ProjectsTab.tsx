...
const projects: Project[] = [
  ...
  {
    title: 'Dotfiles',
    description: 'Personal shell, editor, and environment configuration for Linux workflow.',
    url: 'https://github.com/Quillpy/dotfiles',
    status: 'Iterating',
    type: 'Config',
  ...
  },
  {
    ...
    description: 'Small scripts and solutions from CS50 and other learning adventures.',
  ...
  },
  {
    ...
    description: 'A browser-style personal space for sharing thoughts and work.',
    url: 'https://github.com/Quillpy/portfolio',
    status: 'Growing',
    type: 'Project',
